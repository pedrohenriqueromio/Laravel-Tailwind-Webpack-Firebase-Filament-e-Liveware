...
@section('content')
    ...
    <div class="lg:w-1/2 xl:max-w-screen-sm">
        ...
        <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            ...
            xl:text-bold">Entrar</h2>
            <div class="mt-12">
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <div>
                        <div class="text-sm font-bold text-gray-700 tracking-wide">Email</div>
                        <input id="email" type="email" name="email" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="mike@gmail.com">
                            @error('email')
                    ...
                    <div class="mt-8">
                        ...
                        <input id="password" type="password" name="password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Enter your password">
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                    Não possui conta ? <a href="{{ route('register') }}" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Cadastrar</a>
                </div>
            </div>
        </div>
    </div>
